<template>
  <view class="page">
    <view class="header"><text class="title">试验结果修改</text></view>
    <view class="card" v-if="detail">
      <textarea v-model="content" placeholder="修改后的试验结果" class="textarea" />
...
import { fetchFeedbackDetail, modifyFeedback } from '../../../api/request.js'
...
async function submit() {
  try {
    await modifyFeedback(detail.value.projectId, { content: content.value })
