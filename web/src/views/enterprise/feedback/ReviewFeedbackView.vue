...
import { fetchFeedbackDetail, fetchFeedbackTodos, reviewFeedbackOpinion } from '@/api/feedback'
...
<template>
  <div v-loading="loading">
    <div class="crumb">首页 / 中试反馈管理 / 复核意见反馈页</div>
    <h1 class="title">复核意见反馈</h1>
    <div v-if="detail" class="page-card">
      ...
      <el-input v-model="remark" type="textarea" :rows="4" placeholder="请填写对复核结果的意见" style="margin-bottom:16px" />
